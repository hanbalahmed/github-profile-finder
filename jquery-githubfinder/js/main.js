  ...
  $("#searchUser").on("keyup", function (e) {
    ...
    $.ajax({
      ...
      $.ajax({
        ...
        data: {
          client_id: "2ca8fa9b52b37415bfaa",
          client_secret: "b3c64c4957b2cf885a0e158319f3449444b38510",
          sort: "created: asc",
          per_page: 5,
        },
      }).done(function (repos) {
        $.each(repos, function (index, repo) {
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <a href="https://github.com/hanbalahmed?tab=repositories" target="_blank" class="btn btn-dark">Repo Page</a>
            </div>
          </div>
        </div>
          `);
        ...
        <div class="card border-primary mb-3" style="max-width: 100rem;">
          ...
          <div class="card-body">
            ...
            <div class="col-md-3">
              ...
              <a target="_blank" class="btn btn-success mt-2 btn-block" href="${user.html_url}">View Profile</a>
            </div>
            <div class="col-md-9">
